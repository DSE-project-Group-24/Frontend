describe("Register Admin Page", () => {
  ...
  it("should display all registration fields correctly", () => {
    cy.contains("Register as Hospital Administrator").should("be.visible");
    cy.get("input#name")
      .should("be.visible")
    ...
    cy.get("input#nic")
      .should("be.visible")
      .and("have.attr", "placeholder", "Enter your NIC");
  ...
  it("should show error when registration fails", () => {
    cy.intercept("POST", "**/auth/register/hospital-administrator", {
      statusCode: 400,
  ...
  it("should show loading text while registering", () => {
    cy.intercept("POST", "**/auth/register/hospital-administrator", (req) => {
      req.reply((res) => {
        res.delay = 1000;
